        ...
        <div class="row">
            <div class="span8">
                <div class="inner-heading">
                    <h2>{{ __('CADASTRAR NOVA SENHA') }}</h2>
                </div>
            </div>
            <div class="span4">
                <ul class="breadcrumb">
                    <li><a href="{{  url('/') }}"><i class="fa fa-home"></i></a><i class="fa fa-angle-right"></i></li>
                    <li class="active">{{ __('Cadastrar Nova Senha') }}</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <form method="POST" action="{{ route('password.update') }}" id="form_register">
            ...
            <div class="row">
                ...
                <div class="span6">
                    <input id="email" type="email" class="form-input{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ $email ?? old('email') }}" required autofocus>
