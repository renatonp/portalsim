        ...
        <div class="row">
            ...
            <div class="span4">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Lançamento de ITBI</li>
                </ul>
            </div>
        </div>
    </div>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($registros->aMatriculasCgmEncontradas as $registro)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $registro->tipo }}</td>
                                            <td>{{ utf8_encode(urldecode(iconv('UTF-8', 'ISO-8859-1', $registro->bairro ))) }}</td>
                                            <td>{{ utf8_encode(urldecode(iconv('UTF-8', 'ISO-8859-1', $registro->logradouro ))) }}</td>
                                            <td>{{ $registro->numero }}</td>
                                            <td>{{ utf8_encode(urldecode(iconv('UTF-8', 'ISO-8859-1', $registro->complemento ))) }}</td>
                                            <td>{{ $valBaixa == '0'?"NÃO":"SIM" }}</td>
                                            <td>
...
<script type="text/javascript">
    jQuery(document).ready(function(){
            var table = $('#imoveis').DataTable({
                                ...
                                "targets": -1,
                                "data": null,
                                "defaultContent": "<button>Consultar</button>"
                            } ]
                        });
            ...
            $('#imoveis tbody').on( 'click', 'button', function () {
                ...
                var url = "{{URL::to('/itbitransacao/:id')}}";
