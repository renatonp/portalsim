...
class GoogleRecaptcha
{
    ...
    public static function show($site_key, $after_field_id = 'Form_ContactForm_Comment', $debug = 'no_debug', $extra_class = "mt-4 mb-4", $please_tick_msg = "Please tick the I'm not robot checkbox")
    {
        ...
        $api_js_str = "<script src='https://www.google.com/recaptcha/api.js?hl=pt-BR'></script>";
        ...
        <script>
            ...
            if ( alexEL )   {
                alexEL.parentNode.insertAdjacentHTML('afterend', '<div class="g-recaptcha $extra_class" data-sitekey="$site_key" data-theme="$data_theme" data-expired-callback="onReCaptchaTimeOut" data-error-callback="onReCaptchaError" data-callback="onReCaptchaSuccess"></div>');
