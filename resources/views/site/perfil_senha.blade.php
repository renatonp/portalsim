        ...
        <div class="row">
            ...
            <div class="span6">
                <ul class="breadcrumb">
                    ...
                    {{--  <li><a href="{{  route('perfil') }}">Perfil</a>&nbsp;<i class="fa fa-angle-right"></i></li>
                    --}}
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-10">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('alterarSenha') }}" id="form_register">
                            @csrf
                            <div class="row formrow">
                                ...
                                <div class="span3">
                                    <input id="password_atual" type="password"
                                        class="form-input{{ $errors->has('password_atual') ? ' is-invalid' : '' }}"
                                        name="password_atual">
