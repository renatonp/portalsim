        ...
        <div class="row">
            <div class="span8">
                <div class="inner-heading">
                    <h2>DOCUMENTOS E PROCESSOS</h2>
                </div>
            </div>
            <div class="span4">
                <ul class="breadcrumb">
                    <li><a href="{{  url('/') }}"><i class="fa fa-home"></i></a><i class="fa fa-angle-right"></i></li>
                    <li class="active">Documentos e Processos</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="tabbable tabs-left">
            <ul class="nav nav-tabs">
                <li class="active"><a href="#topone" data-toggle="tab"> Alvará</a></li>
                <li><a href="#toptwo" data-toggle="tab">Certidão</a></li>
            </ul>
            <div class="tab-content">
                <div class="tab-pane active" id="topone">
                    <div class="tab-interna">
                        ...
                        <p>
                            <select id="servico_01-doc" class="servico-opcoes">
                        ...
                        <div class="align-right" >
                            <button type="button" class="btn btn-theme e_wiggle" id="continuar-alvara">
                                {{ __('Continuar') }}
                            </button>
                        </div>
                    </div>
                ...
                <div class="tab-pane" id="toptwo">
                    <div class="tab-interna">
                        ...
                        <p>
                            <select id="servico_02-doc" class="servico-opcoes">
                                <option value="certidao">Certidão Negativa de Débito</option>
                            </select>
                        </p>
                        <div class="align-right" >
                            <button type="button" class="btn btn-theme e_wiggle" id="continuar-certidao">
                                {{ __('Continuar') }}
                            </button>
                        </div>                    
                    </div>
