...
return [
    ...
    */
    ...
    'same'                 => 'Os campos :attribute e :other devem se iguais.',
    'size'                 => [
    ...
    */
    'attributes' => [
        ...
        'email'         => 'E-Mail',
        'email-confirm' => 'Confirmação do E-Mail',
        'cpf'           => 'CPF/CNPJ',
        'pat_cpf'       => 'CPF',
        'sex'           => 'Sexo',
        ...
        'telefone'      => 'Telefone',
        'celular'      => 'Celular',
        'password-confirm'      => 'Senha de Confirmação',
        'password_atual'        => 'Senha Atual',
        'nome_razao_social'     => 'Razão Social',
        'nome_responsavel'      => 'Nome do Responsável',
        'inscricao_estadual'    => 'Inscrição Estadual',
        'doencaDescricao'    => 'Descrição da Doença',
        'declaracao'    => 'Declaração',
        'declaracao1'   => 'Declaração',
        'declaracao2'   => 'Declaração',
        'declaracao3'   => 'Declaração',
        'declaracao4'   => 'Declaração',
        'declaracao5'   => 'Declaração',
        'declaracao6'   => 'Declaração',
    ],
];