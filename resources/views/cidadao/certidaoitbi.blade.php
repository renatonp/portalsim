...
<div class="container-fluid">
    <div class="row">
        <div class="col d-flex justify-content-center">
            <div class="col-lg-12">
                <h2 class="mb-4"><i class="fa fa-file-o"></i> Certidão Quitação ITBI</h2>
                        ...
                        @foreach ($registros->aMatriculasCgmEncontradas as $registro)
                            <div class="callout-red shadow-sm mb-4">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <a href="javascript:;" data-url="{{ route('certidaoQuitacaoItbi', $registro->matricula) }}"
                                            class="selected_certificate btn btn-sm btn-outline-danger d-block">
